...
plugin.setup {
    ...
    keymaps = {
        ...
        file_panel = {
            { "n", "<S-Tab>",       actions.prev_entry,          { desc = "Bring the cursor to the previous file entry." } },
            { "n", "<Tab>",         actions.next_entry,          { desc = "Bring the cursor to the next file entry" } },
            ...
            { "n", "t",             actions.scroll_view(-0.25),  { desc = "Scroll the view up" } },
            { "n", "h",             actions.scroll_view(0.25),   { desc = "Scroll the view down" } },
