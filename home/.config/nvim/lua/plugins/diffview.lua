        ...
        return {
            ...
            keymaps = {
                ...
                view = {
                    ...
                    { "n", "<D-S-s>", actions.toggle_files, { desc = "Toggle the file panel." } },
                    { "n", "<C-CR>", actions.toggle_stage_entry, { desc = "Stage / unstage the selected entry." } },
                ...
                file_panel = {
                    ...
                    { "n", NVKeymaps.scroll_ctx.up, actions.scroll_view(-0.25), { desc = "Scroll diff up" } },
                    { "n", NVKeymaps.scroll_ctx.down, actions.scroll_view(0.25), { desc = "Scroll diff down" } },
                    { "n", "<C-CR>", actions.toggle_stage_entry, { desc = "Stage / unstage the selected entry." } },
